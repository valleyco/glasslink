"""Chart recipes — compose bar / gauge / pie from L1 batch ops."""
...
def gauge(
    ...
    *,
    ...
    """Simple semicircle gauge; value 0..1. Poly wedges + needle line."""
...
def pie(
    ...
    """Pie chart; shares normalized. Each slice ≥3 pts poly."""
    ops: list = []
